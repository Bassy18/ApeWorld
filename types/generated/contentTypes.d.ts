...
export interface ApiBookingBooking extends Schema.CollectionType {
  ...
  attributes: {
    ...
    lodge: Attribute.Relation<
      'api::booking.booking',
      'manyToOne',
      'api::lodge.lodge'
    >;
    num_of_rooms: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 1;
      }> &
      Attribute.DefaultTo<1>;
    isBookingFullfilled: Attribute.String &
      Attribute.SetMinMaxLength<{
        minLength: 1;
        maxLength: 1;
      }> &
...
export interface ApiLodgeLodge extends Schema.CollectionType {
  ...
  attributes: {
    ...
    contact_details: Attribute.Component<'guest-house-info.contact-details'>;
    bookings: Attribute.Relation<
      'api::lodge.lodge',
      'oneToMany',
      'api::booking.booking'
    >;
    main: Attribute.Media & Attribute.Required;
    Pricing: Attribute.Integer & Attribute.Required;
    rating: Attribute.Integer &
      ...
      Attribute.DefaultTo<0>;
    offers: Attribute.Component<'guest-house-info.offers'>;
    reviews: Attribute.Relation<
      'api::lodge.lodge',
      'oneToMany',
      'api::review.review'
    >;
    mapSrc: Attribute.Text;
    room_types: Attribute.Relation<
      'api::lodge.lodge',
      'manyToMany',
      'api::room-type.room-type'
...
export interface ApiRoomTypeRoomType extends Schema.CollectionType {
  ...
  attributes: {
    ...
    numOfRooms: Attribute.Integer;
    image: Attribute.Media;
    lodges: Attribute.Relation<
      'api::room-type.room-type',
      'manyToMany',
      'api::lodge.lodge'
    >;
...
export interface ApiUserInfoUserInfo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    lodgeId: Attribute.Integer & Attribute.DefaultTo<0>;
    lodgeAdmin: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
